...
public class CustomerTests : BaseTest, IClassFixture<EnsureAutoLotDatabaseTestFixture>
{
    ...
    [Fact]
    public void ShouldGetCustomersWithLastNameStartsWithW()
    {
    ...
    [Fact]
    public void ShouldGetCustomersWithLastNameStartsWithWAndFirstNameStartsWithM()
    {
        IQueryable<Customer> query = Context.Customers
            .Where(x => x.PersonInformation.LastName.StartsWith("W"))
    ...
    [Fact]
    public void ShouldGetCustomersWithLastNameStartsWithWOrH()
    {
        IQueryable<Customer> query = Context.Customers
            .Where(x => x.PersonInformation.LastName.StartsWith("W") ||
